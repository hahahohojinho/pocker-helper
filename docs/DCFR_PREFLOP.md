...
The adapter maps `fold` to fold, `call/check` to passive, and `raise/allin` to aggressive. It validates all 169 hands per RFI spot and embeds generator provenance. Do not ship the 100,000-iteration pipeline output as strategy data.
