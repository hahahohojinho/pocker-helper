...
The UI profile is intentionally bounded to one thread, 10 iterations, one bet size, one raise size, and an all-in threshold of 1.0. It is labeled `FAST PREVIEW`; it is not evidence of a fully converged GTO solution.
